...
df = pd.read_csv('Stanovi_Pula_cleaned.csv')
...
card_content_input = [
    dbc.CardHeader("Welcome to my analytical app : Apartments for sale Pula ", style={'font-weight': 'bold',
                                                                                      'text-align': 'center',
                                                                                      }),
    dbc.Card(),
    dbc.CardBody(
        [
            ...
            html.P(
                "This is an interactive web app build completely in Python using Plotly's Dash library. "
                "The app visualizes data through 11 interactive charts. "
                "Data were collected from the website of real estate advertiser for 1429 "
                "apartments that were on sale as of 20.5.2022.",
                className="card-text",
            ),
            html.P(
                ...
                "old apartments because it is very ungrateful to filter this type of data from ads. "
